...
//        return date.isAfter(task.getVersionRelease().getStartDate()) && date.isBefore(task.getVersionRelease().getFinishDate());
//    }
//
...
//        return task.getVersionRelease().getStartDate().isBefore(task.getVersionRelease().getFinishDate());
//    }
//
